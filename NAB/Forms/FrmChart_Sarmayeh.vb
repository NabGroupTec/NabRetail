...
Public Class FrmChart_Sarmayeh
    ...
    Private Sub FrmOtherReport_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Next
        Access_Form = Get_Access_Form("F137")
    ...
    Private Sub GetSarmayeh()
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "FrmChart_Sarmayeh", "GetSarmayeh")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        If DGV.RowCount <= 0 Then
            MessageBox.Show("سرمایه ایی وجود ندارد", "پیغام", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End If
        ...
        For i As Integer = 0 To DGV.RowCount - 1
            If DGV.Item("Cln_Select", i).Value = True Then
                ...
                ListCharge2 &= "Define_Sarmayeh.ID=" & DGV.Item("Cln_Id", i).Value & " OR "
                FrmPrint.Str2 = "نوع سرمایه : " & DGV.Item("Cln_OneGroup", i).Value & " _ " & DGV.Item("Cln_Nam", i).Value
                CountCharge += 1
            End If
        Next
        ...
        If CountCharge = DGV.RowCount Then
            ListCharge = ""
            ListCharge2 = ""
            FrmPrint.Str2 = "نوع سرمایه : ترکیبی"
        ElseIf CountCharge <= 0 Then
            MessageBox.Show("سرمایه ایی انتخاب نشده است", "هشدار", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        Else
            ...
            ListCharge2 &= ")"
            If CountCharge > 1 Then FrmPrint.Str2 = "نوع سرمایه : ترکیبی"
        End If
    ...
    Private Sub GetKey(ByVal e As KeyEventArgs)
        If e.KeyCode = Keys.F1 Then
            Help.ShowHelp(Me, Application.StartupPath & "\Help.chm", HelpNavigator.Topic, "RepNSarmaye.htm")
