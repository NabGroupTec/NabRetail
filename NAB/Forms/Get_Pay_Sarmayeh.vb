...
Public Class Get_Pay_Sarmayeh
    ...
    Private Function RoolBackSanad(ByVal Idfac As Long) As Boolean
        ...
        Try
            ...
            dta = New SqlDataAdapter("SELECT ID FROM  Chk_Get_Pay WHERE ([Type] =21 ) AND (Number_Type = " & Idfac & ")", DataSource)
            dta.Fill(ds)
        ...
        Catch ex As Exception
            ...
            Else
                GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "RoolBackSanad")
            End If
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            Return False
        End Try
    ...
    Private Sub BtnHavaleh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnHavaleh.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "BtnHavaleh_Click")
        End Try
    End Sub
    Private Sub GetKey(ByVal e As KeyEventArgs)
        ...
        ElseIf e.KeyCode = Keys.F1 Then
            Help.ShowHelp(Me, Application.StartupPath & "\Help.chm", HelpNavigator.Topic, "Sarmaye.htm")
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "BtnSave_Click")
        End Try
    End Sub
    Private Function Savepay() As Boolean
        ...
        Try
            ...
            If CDbl(TxtCash.Text) > 0 Then
                Using Cmd As New SqlCommand("INSERT Moein_Box (D_date,disc,mon,T,IdBox,IdUser) VALUES(@D_date,@disc,@mon,@T,@IdBox,@IdUser);SELECT @@IDENTITY", ConectionBank)
                    ...
                    If RdoDec.Checked = True Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "پرداخت سرمایه بابت سند  " & LIdFac.Text & If(String.IsNullOrEmpty(TxtDisc_Cash.Text), "", " - " & TxtDisc_Cash.Text.Trim)
                        Cmd.Parameters.AddWithValue("@T", SqlDbType.Int).Value = 1
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "دریافت سرمایه بابت سند  " & LIdFac.Text & If(String.IsNullOrEmpty(TxtDisc_Cash.Text), "", " - " & TxtDisc_Cash.Text.Trim)
            ...
            If CDbl(Txtbank.Text) > 0 Then
                Using Cmd As New SqlCommand("INSERT Moein_Bank (D_date,disc,mon,T,IDBank,IdUser) VALUES(@D_date,@disc,@mon,@T,@IDBank,@IdUser);SELECT @@IDENTITY", ConectionBank)
                    Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = TxtDate.ThisText
                    If RdoDec.Checked = True Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "پرداخت سرمایه بابت سند  " & LIdFac.Text & If(String.IsNullOrEmpty(TxtDiscbank.Text), "", " - " & TxtDiscbank.Text.Trim)
                        Cmd.Parameters.AddWithValue("@T", SqlDbType.Int).Value = 1
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "دریافت سرمایه بابت سند  " & LIdFac.Text & If(String.IsNullOrEmpty(TxtDiscbank.Text), "", " - " & TxtDiscbank.Text.Trim)
                        Cmd.Parameters.AddWithValue("@T", SqlDbType.Int).Value = 0
                    End If
            ...
            If CDbl(TxtLend.Text) > 0 Then
                If RdoName.Checked = True Then
                    Using Cmd As New SqlCommand("INSERT Moein_People (D_date,disc,mon,T,IdPeople,IdUser,Type,Number_Type,Type_Sanad) VALUES(@D_date,@disc,@mon,@T,@IdPeople,@IdUser,@Type,@Number_Type,@Type_Sanad);SELECT @@IDENTITY", ConectionBank)
                        Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = TxtDate.ThisText
                        If RdoDec.Checked = True Then
                            Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "پرداخت سرمایه بابت سند  " & LIdFac.Text & If(String.IsNullOrEmpty(TxtDiscLend.Text), "", " - " & TxtDiscLend.Text.Trim)
                            Cmd.Parameters.AddWithValue("@T", SqlDbType.Int).Value = 1
                        Else
                            Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "دریافت سرمایه بابت سند  " & LIdFac.Text & If(String.IsNullOrEmpty(TxtDiscLend.Text), "", " - " & TxtDiscLend.Text.Trim)
                            Cmd.Parameters.AddWithValue("@T", SqlDbType.Int).Value = 0
                        End If
                        ...
                        Cmd.Parameters.AddWithValue("@IdUser", SqlDbType.BigInt).Value = IIf(Id_User = 0, DBNull.Value, Id_User)
                        Cmd.Parameters.AddWithValue("@Type", SqlDbType.BigInt).Value = 21
            ...
            End If
            '''''''''''''''ListSarmayeh
            Using Cmd As New SqlCommand("Update Get_Pay_Sarmayeh SET D_date=@D_date,IdSarmayeh=@IdSarmayeh,IdUser=@IdUser,Active=@Active,State=@State,EditFlag=@EditFlag,Cash=@Cash,MonHavaleh=@MonHavaleh,IdBankHavaleh=@IdBankHavaleh,DiscHavaleh=@DiscHavaleh,MonPayChk=@MonPayChk,MonSellChk=@MonSellChk,Lend=@Lend,LendP=@LendP,IdSanadLendP=@IdSanadLendP,LendCharge=@LendCharge,DiscChk=@DiscChk,DiscSellChk=@DiscSellChk,IdBoxMoein=@IdBoxMoein,IdBox=@IdBox,IdBankMoein=@IdBankMoein,AllDisc=@AllDisc,DiscCash=@DiscCash,DiscLend=@DiscLend WHERE Id=@Id", ConectionBank)
                Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = TxtDate.ThisText
                Cmd.Parameters.AddWithValue("@IdSarmayeh", SqlDbType.BigInt).Value = CDbl(TxtIdS.Text)
            ...
            If CDbl(TxtSellChk.Text) > 0 Or CDbl(TxtChk.Text) > 0 Then
                If CDbl(TxtChk.Text) > 0 Then
                    Using Cmd As New SqlCommand("UPDATE Chk_Get_Pay SET Activ=@Active WHERE ([Type] =21) AND (Number_Type = " & LIdFac.Text & ")", ConectionBank)
                        Cmd.Parameters.AddWithValue("@Active", SqlDbType.BigInt).Value = 1
                        Cmd.ExecuteNonQuery()
                    End Using
                End If
                If CDbl(TxtSellChk.Text) > 0 Then
                    Using Cmd As New SqlCommand("UPDATE Chk_Get_Pay SET Activ=@Active WHERE (Kind=0 AND Current_Kind=1) AND (Current_Type =21) AND (Current_Number_Type = " & LIdFac.Text & ")", ConectionBank)
                        Cmd.Parameters.AddWithValue("@Active", SqlDbType.BigInt).Value = 1
                        Cmd.ExecuteNonQuery()
                    End Using
                End If

                Using Cmd As New SqlCommand("UPDATE  Chk_id SET Idsarmayeh =@Idsarmayeh WHERE Id In(SELECT ID From Chk_Get_Pay WHERE ([Type] =21 OR Current_Type =21 ) AND (Number_Type = " & LIdFac.Text & " OR Current_Number_Type = " & LIdFac.Text & " ))", ConectionBank)
                    Cmd.Parameters.AddWithValue("@Idsarmayeh", SqlDbType.BigInt).Value = CLng(TxtIdS.Text)
                    Cmd.ExecuteNonQuery()
                End Using
            End If
            '//////////////////////////////////////////
            ...
            TraceUser(Id_User, GetDate(), CStr(Date.Now.ToLongTimeString), "سرمایه", "جدید", "ثبت سند :" & LIdFac.Text & " نام سرمایه:" & TxtS.Text & " جمع مبلغ:" & LMandeh.Text & If(CDbl(TxtCash.Text) > 0, " نقد:" & TxtCash.Text, "") & If((CDbl(TxtChk.Text) + CDbl(TxtSellChk.Text)) > 0, " چک:" & FormatNumber(CDbl(TxtChk.Text) + CDbl(TxtSellChk.Text), 0), "") & If(CDbl(Txtbank.Text) > 0, " حواله:" & Txtbank.Text, "") & If(CDbl(TxtLend.Text) > 0, " نسیه:" & TxtLend.Text, "") & If(String.IsNullOrEmpty(Txtname.Text), "", " طرف حساب:" & Txtname.Text) & If(String.IsNullOrEmpty(TxtCharge.Text), "", " هزینه:" & TxtCharge.Text) & " نوع پرداخت:" & If(RdoAdd.Checked = True, "افزایش سرمایه", "برداشت سرمایه"), "")
        ...
        Catch ex As Exception
            ...
            Else
                GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "Savepay")
            End If
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            Return False
        End Try
    ...
    Private Function Editpay() As Boolean
        ...
        Try
            ...
            Else
                If Not String.IsNullOrEmpty(TmpId) Then
                    Using Cmd As New SqlCommand("UPDATE Get_Pay_Sarmayeh SET IdBoxMoein=@IdBoxMoein,IdBox=@IdBox WHERE Id=@IdSanad;DELETE FROM  Moein_Box WHERE Id=@ID", ConectionBank)
            ...
            Else
                If Not String.IsNullOrEmpty(TmpId) Then
                    Using Cmd As New SqlCommand("UPDATE Get_Pay_Sarmayeh SET IdBankMoein=@IdBankMoein WHERE Id=@IdSanad;DELETE FROM  Moein_Bank WHERE Id=@ID", ConectionBank)
            ...
            Else
                If Not String.IsNullOrEmpty(TmpId) Then
                    Using Cmd As New SqlCommand("UPDATE Get_Pay_Sarmayeh SET IdSanadLendP=@IdSanadLend WHERE Id=@IdSanad;DELETE FROM  Moein_People WHERE Id=@ID", ConectionBank)
            ...
            TraceUser(Id_User, GetDate(), CStr(Date.Now.ToLongTimeString), "سرمایه", "ویرایش", "ویرایش سند :" & LIdFac.Text & " نام سرمایه:" & TxtS.Text & " جمع مبلغ:" & LMandeh.Text & If(CDbl(TxtCash.Text) > 0, " نقد:" & TxtCash.Text, "") & If((CDbl(TxtChk.Text) + CDbl(TxtSellChk.Text)) > 0, " چک:" & FormatNumber(CDbl(TxtChk.Text) + CDbl(TxtSellChk.Text), 0), "") & If(CDbl(Txtbank.Text) > 0, " حواله:" & Txtbank.Text, "") & If(CDbl(TxtLend.Text) > 0, " نسیه:" & TxtLend.Text, "") & If(String.IsNullOrEmpty(Txtname.Text), "", " طرف حساب:" & Txtname.Text) & If(String.IsNullOrEmpty(TxtCharge.Text), "", " هزینه:" & TxtCharge.Text) & " نوع پرداخت:" & If(RdoAdd.Checked = True, "افزایش سرمایه", "برداشت سرمایه"), "")
        ...
        Catch ex As Exception
            ...
            Else
                GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "Editpay")
            End If
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            Return False
        End Try
    ...
    Private Sub BtnCancle_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancle.Click
        Try
            ...
            Me.Close()
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "BtnCancle_Click")
        End Try
    End Sub
    ...
    Private Sub BtnSodor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSodor.Click
        Try
            If String.IsNullOrEmpty(TxtIdS.Text) Or String.IsNullOrEmpty(TxtS.Text) Then
                MessageBox.Show("هیچ سرمایه ایی جهت صدور چک انتخاب نشده است", "هشدار", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
            If RdoDec.Checked = True Then
            ...
            End If
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "BtnSodor_Click")
        End Try
    End Sub
    ...
    Private Sub GetBoxList()
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "GetBoxList")
        End Try
    End Sub
    ...
    Private Sub GetInfo()
        Try
            ...
            '////////////////////////////////////////
            Using Cmd As New SqlCommand("SELECT  Get_Pay_Sarmayeh.[state],D_date,IdSarmayeh,Cash,MonHavaleh, IdBankHavaleh, DiscHavaleh, MonPayChk, MonSellChk, LendP, IdSanadLendP, LendCharge, DiscChk, DiscSellChk,IdBoxMoein, IdBox,IdBankMoein, AllDisc,DiscCash,DiscLend, Lend, nam, NamP=Case WHEN LendP Is NULL THEN N'' ELSE (SELECT Nam From Define_People  WHERE ID =LendP) End, NamCharge=Case WHEN LendCharge  Is NULL THEN N'' ELSE (SELECT Nam From Define_Charge   WHERE ID =LendCharge ) End FROM Get_Pay_Sarmayeh INNER JOIN Define_Sarmayeh ON Get_Pay_Sarmayeh.IdSarmayeh = Define_Sarmayeh.ID WHERE Get_Pay_Sarmayeh .Id =" & CLng(LIdFac.Text), ConectionBank)
                dt.Load(Cmd.ExecuteReader)
                If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
                If dt.Rows.Count > 0 Then
                    TxtS.Text = dt.Rows(0).Item("nam")
                    TxtIdS.Text = dt.Rows(0).Item("IdSarmayeh")
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "GetInfo")
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            Me.Close()
        End Try
    ...
    Private Sub BtnFroshChk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFroshChk.Click
        Try
            If String.IsNullOrEmpty(TxtIdS.Text) Or String.IsNullOrEmpty(TxtS.Text) Then
                MessageBox.Show("هیچ سرمایه ایی جهت خرج چک مشتری انتخاب نشده است", "هشدار", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "BtnFroshChk_Click")
        End Try
    End Sub
    ...
    Private Function CreateSanad() As Long
        ...
        Try
            If ConectionBank.State <> ConnectionState.Open Then ConectionBank.Open()
            ConectionBank.EnlistTransaction(sqltransaction)
            Using Cmd As New SqlCommand("INSERT Get_Pay_Sarmayeh (Active,State,EditFlag,Cash,MonHavaleh,MonPayChk,MonSellChk,Lend) VALUES(@Active,@State,@EditFlag,@Cash,@MonHavaleh,@MonPayChk,@MonSellChk,@Lend);SELECT @@IDENTITY", ConectionBank)
        ...
        Catch ex As Exception
            ...
            Else
                GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "CreateSanad")
            End If
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            Return 0
        End Try
    ...
    Private Sub BtnDiscCash_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDiscCash.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "BtnDiscCash_Click")
        End Try
    End Sub
    ...
    Private Sub BtnDiscHavaleh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDiscHavaleh.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "BtnDiscHavaleh_Click")
        End Try
    End Sub
    ...
    Private Sub BtnDisc_SellChk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDisc_SellChk.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "BtnDisc_SellChk_Click")
        End Try
    End Sub
    ...
    Private Sub BtnDiscChk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDiscChk.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "BtnDiscChk_Click")
        End Try
    End Sub
    ...
    Private Sub BtnBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBox.Click
        Try
            ...
            Me.GetBoxList()
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "BtnBox_Click")
        End Try
    End Sub
    ...
    Private Sub BtnDiscLend_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDiscLend.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Get_Pay_Sarmayeh", "BtnDiscLend_Click")
        End Try
    End Sub
