...
Public Class ListRelationUser_Two
    ...
    Private Sub Fill_KDgv(ByVal Idvisit As Long)
        Try
            DGV1.DataSource = Nothing
            dsK.Clear()
            strK = "SELECT REPLACE(ListkalaU_G.Kala,'.','/') As Kala , ListkalaU_G.Mon,ListkalaU_G.IdKala,ListkalaU_G.Id,Define_TwoGroup .NamTwo As nam,Define_OneGroup.NamOne As GroupKala FROM ListkalaU_G INNER JOIN Define_TwoGroup  ON ListkalaU_G.Idkala = Define_TwoGroup.Id INNER JOIN Define_OneGroup ON Define_OneGroup.Id =Define_TwoGroup .IdOne WHERE IdLinkUser =" & Idvisit
        ...
        Catch ex As Exception
            ...
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "ListRelationUser_Two", "fill_Kdgv")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub Fill_DDgv(ByVal Idvisit As Long)
        Try
            DGV2.DataSource = Nothing
            dsD.Clear()
            strD = "SELECT REPLACE(ListDarsadU_G.Frosh,'.','/') As Frosh, REPLACE(ListDarsadU_G.Darsad,'.','/') AS Darsad, Define_Group_P.nam,ListDarsadU_G.IdGroup FROM ListDarsadU_G INNER JOIN Define_Group_P ON ListDarsadU_G.IdGroup = Define_Group_P.Id WHERE IdlinkKala =" & Idvisit
        ...
        Catch ex As Exception
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "ListRelationUser_Two", "fill_Ddgv")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub Fill_ODgv(ByVal Idvisit As Long)
        Try
            DGV4.DataSource = Nothing
            dsO.Clear()
            strO = "SELECT  REPLACE(ListOrderDarsadU_G.Darsad,'.','/') As Darsad, Define_Group_P.nam,IdGroup FROM ListOrderDarsadU_G INNER JOIN Define_Group_P ON ListOrderDarsadU_G.IdGroup = Define_Group_P.Id WHERE IdLinkUser =" & Idvisit
        ...
        Catch ex As Exception
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "ListRelationUser_Two", "Fill_ODgv")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub Fill_Dgv()
        ...
        Catch ex As Exception
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "ListRelationUser_Two", "fill_dgv")
            Me.Close()
        End Try
    End Sub
    Private Sub RefreshBank()
        Try
            ...
            dta.Fill(ds, "ListUser_G")
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "ListRelationUser_Two", "RefreshBank")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub BtnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSelect.Click
        ...
        For i As Integer = 0 To DGV1.RowCount - 1
            dt.Clear()
            Using CMD As New SqlCommand("SELECT REPLACE(ListDarsadU_G.Frosh,'.','/') As Frosh, REPLACE(ListDarsadU_G.Darsad,'.','/') AS Darsad, Define_Group_P.nam,ListDarsadU_G.IdGroup FROM ListDarsadU_G INNER JOIN Define_Group_P ON ListDarsadU_G.IdGroup = Define_Group_P.Id WHERE IdlinkKala =" & CLng(DGV1.Item("Cln_Code", i).Value), ConectionBank)
