...
Public Class FrmChartFroshPart
    ...
    Private Sub GetKala()
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "FrmChartFroshPart", "GetKala")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub GetPart()
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "FrmChartFroshPart", "GetPart")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub FrmManageFrosh_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Next
        Access_Form = Get_Access_Form("F140")
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        ...
        For i As Integer = 0 To DGV2.RowCount - 1
            If DGV2.Item("Cln_SelectP", i).Value = True Then
                ListPeople &= "Define_Part.Code =" & DGV2.Item("Cln_IdP", i).Value & " OR "
                TmpListPeople &= "IdPart =" & DGV2.Item("Cln_IdP", i).Value & " OR "
        ...
        If CountPeople > 1 And ChkP.Checked = True Then
            MessageBox.Show("با فعال کردن محدودیت دوره ایی فقط یک مسیر میتواند انتخاب شود", "هشدار", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End If
        ...
        Me.Enabled = False
        TraceUser(Id_User, GetDate(), CStr(Date.Now.ToLongTimeString), "نمودار فروش(مسیر)", "تهیه گزارش", "", "")

        If ChkP.Checked = False Then
            Using FS As New FrmPrint
                FS.Str1 = "نمودار فروش بر حسب مسیر"
                FS.Str2 = namkala
        ...
        Else
            Using FS As New FrmPrint
                FS.Str1 = "نمودار فروش بر حسب مسیر"
                FS.Str2 = "نام مسیر : " & namOstan & If(ChkPart.Checked = True, vbCrLf & "پارت : " & TxtPart.Text.Trim, "")
                ...
                Using cmd As New SqlCommand("SELECT ID FROM Define_People WHERE IdPart =" & IdOstan & If(String.IsNullOrEmpty(Group), "", " AND " & Group), ConectionBank)
    ...
    Private Sub GetKey(ByVal e As KeyEventArgs)
        If e.KeyCode = Keys.F1 Then
            Help.ShowHelp(Me, Application.StartupPath & "\Help.chm", HelpNavigator.Topic, "RepNFPath.htm")
