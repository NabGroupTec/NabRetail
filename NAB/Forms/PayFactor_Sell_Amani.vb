...
Public Class PayFactor_Sell_Amani
    ...
    Private Sub CalCulateMon()
        Try
            ...
            'LMandeh.Text = CDbl(TxtFacMon.Text) - CDbl(TxtDiscountH.Text) - CDbl(TxtDiscountC.Text) - CDbl(TxtCash.Text) - CDbl(Txtbank.Text) - CDbl(TxtChk.Text) - CDbl(TxtLend.Text)
            LMandeh.Text = CDbl(TxtEndMon.Text) - CDbl(TxtDiscountC.Text) - CDbl(TxtCash.Text) - CDbl(Txtbank.Text) - CDbl(TxtChk.Text) - CDbl(TxtLend.Text)
            ...
            If CDbl(TxtDiscountH.Text) > 0 Then
                ...
                Dim tmp As Double = ((CDbl(TxtDiscountH.Text) * 100) / CDbl(TxtFacMon.Text))
    ...
    Private Sub BtnHavaleh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnHavaleh.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnHavaleh_Click")
        End Try
    End Sub
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        Try
            ...
            If CDbl(TxtCash.Text) > 0 And CmbBox.Text = "" Then
                ...
                Exit Sub
            End If
            If LState.Text = "3" Or LState.Text = "5" Or LState.Text = "8" Then
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnSave_Click")
        End Try
    End Sub
    Private Function Savepay() As Boolean
        ...
        If LState.Text = "3" Or LState.Text = "5" Then
        ...
        Try
            ...
            If CDbl(TxtCash.Text) > 0 Then
                Using Cmd As New SqlCommand("INSERT Moein_Box (D_date,disc,mon,T,IdBox,IdUser) VALUES(@D_date,@disc,@mon,@T,@IdBox,@IdUser);SELECT @@IDENTITY", ConectionBank)
                    ...
                    If LState.Text = "1" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "دریافت بابت ف.برگشت از خرید  " & LIdFac.Text & If(String.IsNullOrEmpty(TxtDisc_Cash.Text), "", " - " & TxtDisc_Cash.Text.Trim)
                    ElseIf LState.Text = "8" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "دریافت بابت ف.خدمات  " & LIdFac.Text & If(String.IsNullOrEmpty(TxtDisc_Cash.Text), "", " - " & TxtDisc_Cash.Text.Trim)
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "دریافت بابت  " & If(LState.Text = "3", " ف.فروش", " ف.فروش امانی") & LIdFac.Text & If(String.IsNullOrEmpty(TxtDisc_Cash.Text), "", " - " & TxtDisc_Cash.Text.Trim)
                    End If
            ...
            If CDbl(Txtbank.Text) > 0 Then
                Using Cmd As New SqlCommand("INSERT Moein_Bank (D_date,disc,mon,T,IDBank,IdUser) VALUES(@D_date,@disc,@mon,@T,@IDBank,@IdUser);SELECT @@IDENTITY", ConectionBank)
                    Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = LDate.Text
                    If LState.Text = "1" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "دریافت بابت ف.برگشت از خرید  " & LIdFac.Text & If(String.IsNullOrEmpty(TxtDiscbank.Text), "", " - " & TxtDiscbank.Text.Trim)
                    ElseIf LState.Text = "8" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "دریافت بابت ف.خدمات  " & LIdFac.Text & If(String.IsNullOrEmpty(TxtDiscbank.Text), "", " - " & TxtDiscbank.Text.Trim)
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = "دریافت بابت  " & If(LState.Text = "3", " ف.فروش", " ف.فروش امانی") & LIdFac.Text & If(String.IsNullOrEmpty(TxtDiscbank.Text), "", " - " & TxtDiscbank.Text.Trim)
                    End If
            ...
            If LState.Text <> "5" Then
                Using Cmd As New SqlCommand("INSERT Moein_People (D_date,disc,mon,T,IdPeople,IdUser,Type,Number_Type,Type_Sanad) VALUES(@D_date,@disc,@mon,@T,@IdPeople,@IdUser,@Type,@Number_Type,@Type_Sanad);SELECT @@IDENTITY", ConectionBank)
                    Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = LDate.Text
                    If LState.Text = "1" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " ف.برگشت از خرید" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & DiscFactor
                    ElseIf LState.Text = "8" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " ف.خدمات" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & DiscFactor
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = If(LState.Text = "3", " ف.فروش", " ف.فروش امانی") & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & DiscFactor
                    End If
            ...
            If CDbl(TxtDecMon.Text) > 0 Then
                Using Cmd As New SqlCommand("INSERT Moein_People (D_date,disc,mon,T,IdPeople,IdUser,Type,Number_Type,Type_Sanad) VALUES(@D_date,@disc,@mon,@T,@IdPeople,@IdUser,@Type,@Number_Type,@Type_Sanad);SELECT @@IDENTITY", ConectionBank)
                    Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = LDate.Text
                    If LState.Text = "1" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ کسورات ف.برگشت از خرید" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_DecMon.Text), "", " - " & TxtDisc_DecMon.Text.Trim)
                    ElseIf LState.Text = "8" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ کسورات ف.خدمات" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_DecMon.Text), "", " - " & TxtDisc_DecMon.Text.Trim)
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = If(LState.Text = "3", " مبلغ کسورات ف.فروش", " مبلغ کسورات ف.فروش امانی") & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_DecMon.Text), "", " - " & TxtDisc_DecMon.Text.Trim)
                    End If
            ...
            If CDbl(TxtAddMon.Text) > 0 Then
                Using Cmd As New SqlCommand("INSERT Moein_People (D_date,disc,mon,T,IdPeople,IdUser,Type,Number_Type,Type_Sanad) VALUES(@D_date,@disc,@mon,@T,@IdPeople,@IdUser,@Type,@Number_Type,@Type_Sanad);SELECT @@IDENTITY", ConectionBank)
                    Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = LDate.Text
                    If LState.Text = "1" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ اضافات ف.برگشت از خرید" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_AddMon.Text), "", " - " & TxtDisc_AddMon.Text.Trim)
                    ElseIf LState.Text = "8" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ اضافات ف.خدمات" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_AddMon.Text), "", " - " & TxtDisc_AddMon.Text.Trim)
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = If(LState.Text = "3", " مبلغ اضافات ف.فروش", " مبلغ اضافات ف.فروش امانی") & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_AddMon.Text), "", " - " & TxtDisc_AddMon.Text.Trim)
                    End If
            ...
            If CDbl(TxtDiscountH.Text) > 0 Then
                Using Cmd As New SqlCommand("INSERT Moein_People (D_date,disc,mon,T,IdPeople,IdUser,Type,Number_Type,Type_Sanad) VALUES(@D_date,@disc,@mon,@T,@IdPeople,@IdUser,@Type,@Number_Type,@Type_Sanad);SELECT @@IDENTITY", ConectionBank)
                    Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = LDate.Text
                    If LState.Text = "1" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ تخفیف حجمی ف.برگشت از خرید" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_DisH.Text), "", " - " & TxtDisc_DisH.Text.Trim)
                    ElseIf LState.Text = "8" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ تخفیف حجمی ف.خدمات" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_DisH.Text), "", " - " & TxtDisc_DisH.Text.Trim)
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = If(LState.Text = "3", " مبلغ تخفیف حجمی ف.فروش", " مبلغ تخفیف حجمی ف.فروش امانی") & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_DisH.Text), "", " - " & TxtDisc_DisH.Text.Trim)
                    End If
            ...
            If CDbl(TxtDiscountC.Text) > 0 Then
                Using Cmd As New SqlCommand("INSERT Moein_People (D_date,disc,mon,T,IdPeople,IdUser,Type,Number_Type,Type_Sanad) VALUES(@D_date,@disc,@mon,@T,@IdPeople,@IdUser,@Type,@Number_Type,@Type_Sanad);SELECT @@IDENTITY", ConectionBank)
                    Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = LDate.Text
                    If LState.Text = "1" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ تخفیف نقدی ف.برگشت از خرید" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_DisC.Text), "", " - " & TxtDisc_DisC.Text.Trim)
                    ElseIf LState.Text = "8" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ تخفیف نقدی ف.خدمات" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_DisC.Text), "", " - " & TxtDisc_DisC.Text.Trim)
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = If(LState.Text = "3", " مبلغ تخفیف نقدی ف.فروش", " مبلغ تخفیف نقدی ف.فروش امانی") & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_DisC.Text), "", " - " & TxtDisc_DisC.Text.Trim)
                    End If
            ...
            If CDbl(TxtCash.Text) > 0 Then
                Using Cmd As New SqlCommand("INSERT Moein_People (D_date,disc,mon,T,IdPeople,IdUser,Type,Number_Type,Type_Sanad) VALUES(@D_date,@disc,@mon,@T,@IdPeople,@IdUser,@Type,@Number_Type,@Type_Sanad);SELECT @@IDENTITY", ConectionBank)
                    Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = LDate.Text
                    If LState.Text = "1" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ نقد ف.برگشت از خرید" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_Cash.Text), "", " - " & TxtDisc_Cash.Text.Trim)
                    ElseIf LState.Text = "8" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ نقد ف.خدمات" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_Cash.Text), "", " - " & TxtDisc_Cash.Text.Trim)
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = If(LState.Text = "3", " مبلغ نقد ف.فروش", " مبلغ نقد ف.فروش امانی") & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_Cash.Text), "", " - " & TxtDisc_Cash.Text.Trim)
                    End If
                    Cmd.Parameters.AddWithValue("@mon", SqlDbType.BigInt).Value = CDbl(TxtCash.Text)
                    Cmd.Parameters.AddWithValue("@T", SqlDbType.Int).Value = 1
                    Cmd.Parameters.AddWithValue("@IdPeople", SqlDbType.BigInt).Value = CLng(LIdname.Text)
            ...
            If CDbl(Txtbank.Text) > 0 Then
                Using Cmd As New SqlCommand("INSERT Moein_People (D_date,disc,mon,T,IdPeople,IdUser,Type,Number_Type,Type_Sanad) VALUES(@D_date,@disc,@mon,@T,@IdPeople,@IdUser,@Type,@Number_Type,@Type_Sanad);SELECT @@IDENTITY", ConectionBank)
                    Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = LDate.Text
                    If LState.Text = "1" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ حواله بانکی ف.برگشت از خرید" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDiscbank.Text), "", " - " & TxtDiscbank.Text.Trim)
                    ElseIf LState.Text = "8" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ حواله بانکی ف.خدمات" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDiscbank.Text), "", " - " & TxtDiscbank.Text.Trim)
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = If(LState.Text = "3", " مبلغ حواله بانکی ف.فروش", " مبلغ حواله بانکی ف.فروش امانی") & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDiscbank.Text), "", " - " & TxtDiscbank.Text.Trim)
                    End If
                    Cmd.Parameters.AddWithValue("@mon", SqlDbType.BigInt).Value = CDbl(Txtbank.Text)
                    Cmd.Parameters.AddWithValue("@T", SqlDbType.Int).Value = 1
                    Cmd.Parameters.AddWithValue("@IdPeople", SqlDbType.BigInt).Value = CLng(LIdname.Text)
            ...
            If CDbl(TxtChk.Text) > 0 Then
                Using Cmd As New SqlCommand("INSERT Moein_People (D_date,disc,mon,T,IdPeople,IdUser,Type,Number_Type,Type_Sanad) VALUES(@D_date,@disc,@mon,@T,@IdPeople,@IdUser,@Type,@Number_Type,@Type_Sanad);SELECT @@IDENTITY", ConectionBank)
                    Cmd.Parameters.AddWithValue("@D_date", SqlDbType.NVarChar).Value = LDate.Text
                    If LState.Text = "1" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ چک ف.برگشت از خرید" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_Chk.Text), "", " - " & TxtDisc_Chk.Text.Trim)
                    ElseIf LState.Text = "8" Then
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = " مبلغ چک ف.خدمات" & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_Chk.Text), "", " - " & TxtDisc_Chk.Text.Trim)
                    Else
                        Cmd.Parameters.AddWithValue("@Disc", SqlDbType.NVarChar).Value = If(LState.Text = "3", " مبلغ چک ف.فروش", " مبلغ چک ف.فروش امانی") & LIdFac.Text & If(String.IsNullOrEmpty(LHandNumber.Text.Trim), "", " شماره دستی " & LHandNumber.Text) & If(String.IsNullOrEmpty(TxtDisc_Chk.Text), "", " - " & TxtDisc_Chk.Text.Trim)
                    End If
            ...
            Dim query As String = ""
            If LState.Text = "3" Or LState.Text = "5" Then
                query = "Update " & ListName & " SET Activ=@Activ,EditFlag=@EditFlag,IdSanadFactor=@IdSanadFactor,MonAdd=@MonAdd,DiscAdd=@DiscAdd,IdSanadAdd=@IdSanadAdd,MonDec=@MonDec,DiscDec=@DiscDec,IdSanadDec=@IdSanadDec,IdSanadDiscountH=@IdSanadDiscountH,IdSanadDiscountC=@IdSanadDiscountC,DiscDisH=@DiscDisH,DiscDisC=@DiscDisC,Discount=@Discount,Cash=@Cash,IdSanadCash=@IdSanadCash,IdBox=@IdBox,DiscCash=@DiscCash,MonHavaleh=@MonHavaleh,IdBankHavaleh=@IdBankHavaleh,DiscHavaleh=@DiscHavaleh,IdSanadHavaleh=@IdSanadHavaleh,IdBank=@IdBank,MonPayChk=@MonPayChk,IdSanadChk=@IdSanadChk,DiscChk=@DiscChk,KindFrosh=@KindFrosh WHERE IdFactor=@IdFactor;UPDATE " & KalaName & " SET Activ=@Activ WHERE IdFactor=@IdFactor"
            Else
                query = "Update " & ListName & " SET Activ=@Activ,EditFlag=@EditFlag,IdSanadFactor=@IdSanadFactor,MonAdd=@MonAdd,DiscAdd=@DiscAdd,IdSanadAdd=@IdSanadAdd,MonDec=@MonDec,DiscDec=@DiscDec,IdSanadDec=@IdSanadDec,IdSanadDiscountH=@IdSanadDiscountH,IdSanadDiscountC=@IdSanadDiscountC,DiscDisH=@DiscDisH,DiscDisC=@DiscDisC,Discount=@Discount,Cash=@Cash,IdSanadCash=@IdSanadCash,IdBox=@IdBox,DiscCash=@DiscCash,MonHavaleh=@MonHavaleh,IdBankHavaleh=@IdBankHavaleh,DiscHavaleh=@DiscHavaleh,IdSanadHavaleh=@IdSanadHavaleh,IdBank=@IdBank,MonPayChk=@MonPayChk,IdSanadChk=@IdSanadChk,DiscChk=@DiscChk WHERE IdFactor=@IdFactor;UPDATE " & KalaName & " SET Activ=@Activ WHERE IdFactor=@IdFactor"
            End If

            Using Cmd As New SqlCommand(query, ConectionBank)
                If LState.Text = "3" Or LState.Text = "5" Then Cmd.Parameters.AddWithValue("@KindFrosh", SqlDbType.BigInt).Value = GetKindFrosh()
        ...
        Catch ex As Exception
            ...
            Else
                GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "Savepay")
            End If
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            Return False
        End Try
    ...
    Private Function Editpay() As Boolean
        ...
        Try
            ...
            Else
                query = "Update " & ListName & " SET D_date=@D_date,IdName=@IdName,Part=@Part,Sanad=@Sanad,IdVisitor=@IdVisitor,IdUser=@IdUser,Disc=@Disc,IdSanadFactor=@IdSanadFactor,MonAdd=@MonAdd,DiscAdd=@DiscAdd,IdSanadAdd=@IdSanadAdd,MonDec=@MonDec,DiscDec=@DiscDec,IdSanadDec=@IdSanadDec,IdSanadDiscountH=@IdSanadDiscountH,IdSanadDiscountC=@IdSanadDiscountC,DiscDisH=@DiscDisH,DiscDisC=@DiscDisC,Discount=@Discount,Cash=@Cash,IdSanadCash=@IdSanadCash,IdBox=@IdBox,DiscCash=@DiscCash,MonHavaleh=@MonHavaleh,IdBankHavaleh=@IdBankHavaleh,DiscHavaleh=@DiscHavaleh,IdSanadHavaleh=@IdSanadHavaleh,IdBank=@IdBank,MonPayChk=@MonPayChk,IdSanadChk=@IdSanadChk,DiscChk=@DiscChk WHERE IdFactor=@IdFactor"
            End If
            ...
            If LState.Text = "8" Then
                TmpId = "INSERT INTO " & KalaName & "(IdFactor,IdService,KolCount,Fe,DarsadDiscount,DarsadMon,Mon,KalaDisc,Activ) VALUES(@IdFactor,@IdService,@KolCount,@Fe,@DarsadDiscount,@DarsadMon,@Mon,@KalaDisc,@Activ)"
            Else
            ...
            If ChKLend.Checked = True Then
                Dim StrTmp As String = ""
                If String.IsNullOrEmpty(TmpId) Then
                    StrTmp = "INSERT Wanted_frosh (IdFactor,Rate) VALUES(@IdFactor,@Rate)"
                Else
                    StrTmp = "UPDATE Wanted_frosh  SET Rate=@Rate WHERE IdFactor=@IdFactor"
                End If
                Using Cmd As New SqlCommand(StrTmp, ConectionBank)
                    Cmd.Parameters.AddWithValue("@IdFactor", SqlDbType.BigInt).Value = LIdFac.Text
                    Cmd.Parameters.AddWithValue("@Rate", SqlDbType.BigInt).Value = TxtTime.Text
            ...
            Else
                If Not String.IsNullOrEmpty(TmpId) Then
                    Using Cmd As New SqlCommand("Delete FROM Wanted_frosh WHERE IdFactor=@IdFactor;Delete FROM PayLimitFrosh WHERE IdFactor=@IdFactor", ConectionBank)
                        Cmd.Parameters.AddWithValue("@IdFactor", SqlDbType.BigInt).Value = CLng(LIdFac.Text)
                        Cmd.ExecuteNonQuery()
                    End Using
                End If
            ...
            If CDbl(TxtChk.Text) > 0 Then
                ...
                'Using Cmd As New SqlCommand("UPDATE Chk_Id SET Current_IdPeople  =" & LIdname.Text & " WHERE (IdBank Is Null) AND Current_IdPeople=IdPeople AND Id IN (SELECT ID FROM  Chk_Get_Pay  WHERE ([Type] =" & LState.Text & " ) AND (Number_Type = " & LIdFac.Text & "));UPDATE Chk_Id SET IdPeople =" & LIdname.Text & " WHERE Id IN (SELECT ID FROM  Chk_Get_Pay  WHERE ([Type] =" & LState.Text & " ) AND (Number_Type = " & LIdFac.Text & "));UPDATE Moein_People SET IDPeople =" & TxtIdName.Text & " WHERE T=0 AND ID IN (SELECT PeopleMoein FROM Sanad_ChangeChk  WHERE IdChk IN (SELECT ID FROM  Chk_Get_Pay  WHERE ([Type] =12 ) AND (Number_Type =" & LIdFac.Text & ")))", ConectionBank)
                '    Cmd.ExecuteNonQuery()
                'End Using
                ''//////////////////////////////////////////////////////////////

                Using Cmd As New SqlCommand("UPDATE Chk_Id SET Current_IdPeople  =" & LIdname.Text & " WHERE (IdBank Is Null) AND Current_IdPeople=IdPeople AND Id IN (SELECT ID FROM  Chk_Get_Pay  WHERE ([Type] =" & LState.Text & " ) AND (Number_Type = " & LIdFac.Text & "));UPDATE Chk_Id SET IdPeople =" & LIdname.Text & " WHERE Id IN (SELECT ID FROM  Chk_Get_Pay  WHERE ([Type] =" & LState.Text & " ) AND (Number_Type = " & LIdFac.Text & "))", ConectionBank)
                    Cmd.ExecuteNonQuery()
                End Using

                'Using Cmd As New SqlCommand("UPDATE Chk_Id SET IdPeople =" & LIdname.Text & " WHERE Id IN (SELECT ID FROM  Chk_Get_Pay  WHERE ([Type] =" & LState.Text & " ) AND (Number_Type = " & LIdFac.Text & "));UPDATE Chk_Id SET Current_IdPeople  =" & LIdname.Text & " WHERE (IdBank Is Null)  AND Id IN (SELECT ID FROM  Chk_Get_Pay  WHERE ([Type] =" & LState.Text & " ) AND (Number_Type = " & LIdFac.Text & "))", ConectionBank)
                '    Cmd.ExecuteNonQuery()
                'End Using
        ...
        Catch ex As Exception
            ...
            Else
                GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "Editpay")
            End If
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            Return False
        End Try
    ...
    Private Sub BtnCancle_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancle.Click
        Try
            ...
            Me.Close()
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnCancle_Click")
        End Try
    End Sub
    ...
    Private Sub BtnSodor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSodor.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnSodor_Click")
        End Try
    End Sub
    ...
    Private Sub PayFactor_Buy_Amani_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If LState.Text = "3" Or LState.Text = "5" Then
            ...
            If LEdit.Text = "0" Then CmbFrosh.Text = CmbFrosh.Items.Item(2)
        End If
    End Sub
    ...
    Private Sub GetInfo()
        Try
            ...
            Dim query As String = ""
            If LState.Text = "3" Or LState.Text = "5" Then
                query = "SELECT MonAdd,IdSanadAdd ,mondec,idsanaddec,IdsanadDiscountH,discount,idsanaddiscountc,cash,idsanadcash,monhavaleh,idbankHavaleh,discHavaleh,MonPayChk,idsanadChk,idsanadHavaleh,DiscAdd,DiscDec,DiscDish,discdisc,DiscChk,discCash,IdBox,IdBank,IdSanadFactor,KindFrosh,(SELECT Rate FROM Wanted_Frosh WHERE IdFactor =" & CLng(LIdFac.Text) & ")As Rate FROM " & GetTableNameFactor(CLng(LState.Text), "LIST") & " WHERE IdFactor =" & CLng(LIdFac.Text)
            Else
                query = "SELECT MonAdd,IdSanadAdd ,mondec,idsanaddec,IdsanadDiscountH,discount,idsanaddiscountc,cash,idsanadcash,monhavaleh,idbankHavaleh,discHavaleh,MonPayChk,idsanadChk,idsanadHavaleh,DiscAdd,DiscDec,DiscDish,discdisc,DiscChk,discCash,IdBox,IdBank,IdSanadFactor,(SELECT Rate FROM Wanted_Frosh WHERE IdFactor =" & CLng(LIdFac.Text) & ")As Rate FROM " & GetTableNameFactor(CLng(LState.Text), "LIST") & " WHERE IdFactor =" & CLng(LIdFac.Text)
            End If
            Using Cmd As New SqlCommand(query, ConectionBank)
                Cmd.Parameters.AddWithValue("@IdFactor", SqlDbType.BigInt).Value = CLng(LIdFac.Text)
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    Try
                        If LState.Text = "3" Or LState.Text = "5" Then CmbFrosh.Text = CmbFrosh.Items.Item(dt.Rows(0).Item("KindFrosh"))
                    Catch ex As Exception
                        CmbFrosh.Text = CmbFrosh.Items.Item(2)
                    End Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "GetInfo")
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            Me.Close()
        End Try
    ...
    Private Sub GetBoxList()
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "GetBoxList")
        End Try
    End Sub
    ...
    Private Sub BtnDiscDec_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDiscDec.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnDiscDec_Click")
        End Try
    End Sub
    ...
    Private Sub BtnDiscAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDiscAdd.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnDiscAdd_Click")
        End Try
    End Sub
    ...
    Private Sub BtnDiscDisH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDiscDisH.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnDiscDisH_Click")
        End Try
    End Sub
    ...
    Private Sub BtnDiscDisC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDiscDisC.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnDiscDisC_Click")
        End Try
    End Sub
    ...
    Private Sub BtnDiscCash_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDiscCash.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnDiscCash_Click")
        End Try
    End Sub
    ...
    Private Sub BtnDiscHavaleh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDiscHavaleh.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnDiscHavaleh_Click")
        End Try
    End Sub
    ...
    Private Sub BtnDiscChk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDiscChk.Click
        Try
            ...
            End Using
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnDiscChk_Click")
        End Try
    End Sub
    ...
    Private Sub BtnBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBox.Click
        Try
            ...
            Me.GetBoxList()
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "BtnBox_Click")
        End Try
    End Sub
    ...
    Private Sub TxtDate_TextChanging(ByVal sender As Object, ByVal e As String) Handles TxtDate.TextChanging
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "TxtDate_TextChanging")
            TxtDate.ThisText = LDate.Text
            TxtTime.Text = "0"
        End Try
    End Sub
    ...
    Private Sub GetMalyat(ByVal St As Long)
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "PayFactor_Sell_Amani", "GetMalyat")
            TxtAddDarsad.Text = 0
            TxtDecDarsad.Text = 0
        End Try
    End Sub
