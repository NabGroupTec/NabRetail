...
Public Class Exit_List
    ...
    Private Sub GetExitFactor()
        Try
            ...
            End If
            '''''''''''''''''''''''''''
            Dta = New SqlDataAdapter("SELECT Id FROM ExitFactor", DataSource)
            Dta.Fill(Ds, "ExitFactor")
            DGV.AutoGenerateColumns = False
            dv = Ds.Tables("ExitFactor").DefaultView
            DGV.DataSource = dv
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Exit_List", "GetExitFactor")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub RefreshBank()
        Try
            ...
            TxtSearch.Text = ""
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "Exit_List", "RefreshBank")
        End Try
    End Sub
