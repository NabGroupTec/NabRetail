...
Public Class Traz2Column
    Dim Dt As New DataTable
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        TraceUser(Id_User, GetDate(), CStr(Date.Now.ToLongTimeString), "تراز دو ستونی", "چاپ تراز", "", "")
        FrmPrint.DtTraz = Dt
        FrmPrint.CHoose = "TRAZ2"
        FrmPrint.ShowDialog()
    End Sub
    ...
    Private Sub GetKey(ByVal e As KeyEventArgs)
        ...
        ElseIf e.KeyCode = Keys.F1 Then
            Help.ShowHelp(Me, Application.StartupPath & "\Help.chm", HelpNavigator.Topic, "Tarzsetoni.htm")
    ...
    Private Sub RefreshBank()
        Try
            ...
            For i As Integer = 0 To Dt.Rows.Count - 1
                ...
                End If
                str(1) = If(Dt.Rows(i).Item("BedAllMon").ToString.Length < 3, Dt.Rows(i).Item("BedAllMon"), FormatNumber(Dt.Rows(i).Item("BedAllMon"), 0))
                str(2) = If(Dt.Rows(i).Item("BesAllMon").ToString.Length < 3, Dt.Rows(i).Item("BesAllMon"), FormatNumber(Dt.Rows(i).Item("BesAllMon"), 0))
        ...
        If (Access_Form <> "-1") Then
            ...
            Else
                ...
                Else
                    ...
                    End If
                    Me.RefreshBank()
                    TraceUser(Id_User, GetDate(), CStr(Date.Now.ToLongTimeString), "تراز دو ستونی", "ورود", "", "")
                End If
            End If
        Else
            Me.RefreshBank()
