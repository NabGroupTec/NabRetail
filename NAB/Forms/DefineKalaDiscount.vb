...
Public Class DefineKalaDiscount
    Dim ROW As Integer
    Dim ds As New DataSet
    Dim str As String = "SELECT ListKala_Discount.Idkala,ListKala_Discount.AutoDiscount, ListKala_Discount.Coding, Define_Kala.Nam, Define_OneGroup.NamOne +'-'+ Define_TwoGroup.NamTwo As GroupKala FROM ListKala_Discount INNER JOIN Define_Kala ON ListKala_Discount.Idkala = Define_Kala.Id INNER JOIN Define_OneGroup ON Define_Kala.IdCodeOne = Define_OneGroup.Id INNER JOIN Define_TwoGroup ON Define_Kala.IdCodeTwo = Define_TwoGroup.Id AND Define_OneGroup.Id = Define_TwoGroup.IdOne"
    ...
    Private Sub Fill_Dgv()
        Try
            ...
            dta.Fill(ds, "ListKala_Discount")
            DGV.AutoGenerateColumns = False
            bs.DataSource = ds
            bs.DataMember = "ListKala_Discount"
            DGV.DataSource = bs
            BN.BindingSource = bs
        Catch ex As Exception
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "DefineKalaDiscount", "fill_dgv")
            Me.Close()
        End Try
    End Sub
    Private Sub Fill_KDgv(ByVal IdCity As Long)
        Try
            DGV2.DataSource = Nothing
            dsK.Clear()
            strK = "SELECT Kala_Discount.Joz, Kala_Discount.Kol, Kala_Discount.JozCount, Kala_Discount.KolCount, Define_Kala.Nam FROM Kala_Discount INNER JOIN Define_Kala ON Kala_Discount.Idkala = Define_Kala.Id WHERE  Kala_Discount.IdKalaLink  =" & IdCity & " UNION ALL SELECT Kala_Discount.Joz, Kala_Discount.Kol, Kala_Discount.JozCount, Kala_Discount.KolCount, Define_Service.Nam FROM Kala_Discount INNER JOIN Define_Service ON Kala_Discount.IdService  = Define_Service.Id WHERE  Kala_Discount.IdKalaLink =" & IdCity
            If Not dtaK Is Nothing Then
                dtaK.Dispose()
            End If
            '''''''''''''''''''''''''''
            dtaK = New SqlDataAdapter(strK, DataSource)
            dtaK.Fill(dsK, "Kala_Discount")
            DGV2.AutoGenerateColumns = False
            bsK.DataSource = dsK
            bsK.DataMember = "Kala_Discount"
            DGV2.DataSource = bsK
        Catch ex As Exception
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "DefineKalaDiscount", "fill_Kdgv")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub DefineCostKala_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Next
        Access_Form = Get_Access_Form("F124")
    ...
    Private Sub SetButton()
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "DefineKalaDiscount", "SetButton")
            Me.Close()
        End Try
    End Sub
    Private Sub RefreshBank()
        Try
            ...
            dta.Fill(ds, "ListKala_Discount")
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "DefineKalaDiscount", "RefreshBank")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub cmdadd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdadd.Click
        Try
            Using FrmAdd As New FrmDiscountKala
                FrmAdd.EDIT.Text = "0"
                FrmAdd.ShowDialog()
            End Using
            Me.RefreshBank()
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "DefineKalaDiscount", "cmdadd_Click")
            Me.RefreshBank()
        End Try
    End Sub
    ...
    Private Sub cmdedit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdedit.Click
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "DefineKalaDiscount", "cmdedit_Click")
            Me.RefreshBank()
        End Try
    End Sub
    ...
    Private Sub cmddel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmddel.Click
        Try
            ...
            If str = 6 Then
                ...
                TraceUser(Id_User, GetDate(), CStr(Date.Now.ToLongTimeString), "رابطه کالا و جایزه", "حذف", "حذف جایزه کالای :" & DGV.Item("Cln_Nam", DGV.CurrentRow.Index).Value, "")
                Me.RefreshBank()
            End If
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "DefineKalaDiscount", "cmddel_Click")
            Me.RefreshBank()
        End Try
    End Sub
    Private Function DeleteKala(ByVal Id As Long) As Boolean
        ...
        Try
            ...
            Using Cmd As New SqlCommand("DELETE FROM ListKala_Discount WHERE Idkala=@Idkala", ConectionBank)
        ...
        Catch ex As Exception
            ...
            Else
                GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "DefineKalaDiscount", "DeleteCity")
            End If
            Me.RefreshBank()
            Return False
        End Try
    ...
    Private Function DeleteEndCity(ByVal Id As Long) As Boolean
        ...
        Catch ex As Exception
            ...
            If Err.Number = 5 Then
                ' MessageBox.Show("کالای انتخابی شما قابل حذف شدن نیست", "هشدار", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Else
                GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "DefineKalaDiscount", "DeleteEndCity")
            End If
            Me.RefreshBank()
            Return False
        End Try
