...
Public Class ListRelationVisit_One
    ...
    Private Sub Fill_KDgv(ByVal Idvisit As Long)
        ...
        Catch ex As Exception
            ...
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "ListRelationVisit_One", "fill_Kdgv")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub Fill_DDgv(ByVal Idvisit As Long)
        Try
            DGV2.DataSource = Nothing
            dsD.Clear()
            strD = "SELECT REPLACE(ListDarsad_OG.Frosh,'.','/') As Frosh, REPLACE(ListDarsad_OG.Darsad,'.','/') AS Darsad, Define_Group_P.nam,ListDarsad_OG.IdGroup FROM ListDarsad_OG INNER JOIN Define_Group_P ON ListDarsad_OG.IdGroup = Define_Group_P.Id WHERE IdlinkKala =" & Idvisit
        ...
        Catch ex As Exception
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "ListRelationVisit_One", "fill_Ddgv")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub Fill_ODgv(ByVal Idvisit As Long)
        Try
            DGV4.DataSource = Nothing
            dsO.Clear()
            strO = "SELECT  REPLACE(ListOrderDarsad_OG.Darsad,'.','/') As Darsad, Define_Group_P.nam,IdGroup FROM ListOrderDarsad_OG INNER JOIN Define_Group_P ON ListOrderDarsad_OG.IdGroup = Define_Group_P.Id WHERE IdLinkVisitor =" & Idvisit
        ...
        Catch ex As Exception
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "ListRelationVisit_One", "Fill_ODgv")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub Fill_Dgv()
        ...
        Catch ex As Exception
            If ConectionBank.State = ConnectionState.Open Then ConectionBank.Close()
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "ListRelationVisit_One", "fill_dgv")
            Me.Close()
        End Try
    End Sub
    Private Sub RefreshBank()
        Try
            ...
            dta.Fill(ds, "ListVisitor_OG")
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "ListRelationVisit_One", "RefreshBank")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub BtnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSelect.Click
        ...
        For i As Integer = 0 To DGV1.RowCount - 1
            dt.Clear()
            Using CMD As New SqlCommand("SELECT REPLACE(ListDarsad_OG.Frosh,'.','/') As Frosh, REPLACE(ListDarsad_OG.Darsad,'.','/') AS Darsad, Define_Group_P.nam,ListDarsad_OG.IdGroup FROM ListDarsad_OG INNER JOIN Define_Group_P ON ListDarsad_OG.IdGroup = Define_Group_P.Id WHERE IdlinkKala =" & CLng(DGV1.Item("Cln_Code", i).Value), ConectionBank)
