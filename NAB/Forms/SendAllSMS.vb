...
Public Class SendAllSMS
    ...
    Private Sub Filldata()
        ...
        Catch ex As Exception
            If ConectionBank.State <> ConnectionState.Open Then ConectionBank.Close()
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "SendAllSMS", "Filldata")
            Me.Close()
        End Try
    End Sub
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            For i As Integer = 0 To DGV1.RowCount - 1
                ...
                Else
                    ...
                    lSendReference = ActiveSMS.axKylixSMS.SendSMS(DGV1.Item("cln_tell", i).Value, GetMessage(DGV1.Item("cln_name", i).Value, DGV1.Item("cln_Mon", i).Value, DGV1.Item("cln_State", i).Value))
        ...
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "SendAllSMS", "Button1_Click")
            Button1.Enabled = True
            ChkInvalid.Enabled = True
            DGV1.AllowUserToDeleteRows = True
            Button2.Enabled = False
        End Try
    End Sub
    Private Function GetMessage(ByVal nam As String, ByVal Mon As Double, ByVal State As String) As String
        Return "حساب شما " & IIf(Mon = 0, 0, FormatNumber(Mon, 0)) & "(" & If(State = "بد", "بدهکار", "بستانکار") & ")" & "میباشد. " & "از طرف:" & namcompany
    End Function
    ...
    Private Sub DelInvalidNumber()
        Try
            ...
            Next
        Catch ex As Exception
            GetError(ex.Message & vbCrLf & vbCrLf & ex.StackTrace, "SendAllSMS", "DelInvalidNumber")
        End Try
    End Sub
