...
Public Class CRP_ControMali2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_ControMali2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_ControMali2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_ControMali2 = New CRP_ControMali2()
        rpt.Site = Me.Site
        Return rpt
    End Function
