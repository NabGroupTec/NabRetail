...
Public Class CRP_Report_OneChk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Report_OneChk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Report_OneChk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Report_OneChk = New CRP_Report_OneChk()
        rpt.Site = Me.Site
        Return rpt
    End Function
