...
Public Class CRP_EndSarmayeh
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_EndSarmayeh.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_EndSarmayeh
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_EndSarmayeh = New CRP_EndSarmayeh()
        rpt.Site = Me.Site
        Return rpt
    End Function
