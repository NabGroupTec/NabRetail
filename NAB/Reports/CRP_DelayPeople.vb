...
Public Class CRP_DelayPeople
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_DelayPeople.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_DelayPeople
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_DelayPeople = New CRP_DelayPeople()
        rpt.Site = Me.Site
        Return rpt
    End Function
