...
Public Class CRP_Resid_Anbar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Resid_Anbar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Resid_Anbar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Resid_Anbar = New CRP_Resid_Anbar()
        rpt.Site = Me.Site
        Return rpt
    End Function
