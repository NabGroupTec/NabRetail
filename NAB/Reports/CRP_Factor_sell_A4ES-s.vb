...
Public Class CRP_Factor_sell_A4ES_s
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRP_Factor_sell_A4ES-s.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Factor_sell_A4ES-s.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Factor_sell_A4ES_s
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Factor_sell_A4ES_s = New CRP_Factor_sell_A4ES_s()
        rpt.Site = Me.Site
        Return rpt
    End Function
