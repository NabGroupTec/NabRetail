...
Public Class CRP_Report_Delay
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Report_Delay.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Report_Delay
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Report_Delay = New CRP_Report_Delay()
        rpt.Site = Me.Site
        Return rpt
    End Function
