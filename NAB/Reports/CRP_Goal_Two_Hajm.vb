...
Public Class CRP_Goal_Two_Hajm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Goal_Two_Hajm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Goal_Two_Hajm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Goal_Two_Hajm = New CRP_Goal_Two_Hajm()
        rpt.Site = Me.Site
        Return rpt
    End Function
