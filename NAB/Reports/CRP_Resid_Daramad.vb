...
Public Class CRP_Resid_Daramad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Resid_Daramad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Resid_Daramad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Resid_Daramad = New CRP_Resid_Daramad()
        rpt.Site = Me.Site
        Return rpt
    End Function
