...
Public Class CRP_Report_Delay2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Report_Delay2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Report_Delay2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Report_Delay2 = New CRP_Report_Delay2()
        rpt.Site = Me.Site
        Return rpt
    End Function
