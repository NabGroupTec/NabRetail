...
Public Class CRP_Goal_Two_Mon
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Goal_Two_Mon.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Goal_Two_Mon
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Goal_Two_Mon = New CRP_Goal_Two_Mon()
        rpt.Site = Me.Site
        Return rpt
    End Function
