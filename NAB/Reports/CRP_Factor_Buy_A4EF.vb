...
Public Class CRP_Factor_Buy_A4EF
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRP_Factor_Buy_A4EF.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Factor_Buy_A4EF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Factor_Buy_A4EF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Factor_Buy_A4EF = New CRP_Factor_Buy_A4EF()
        rpt.Site = Me.Site
        Return rpt
    End Function
