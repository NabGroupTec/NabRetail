...
Public Class CRP_Traz4Column
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Traz4Column.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Traz4Column
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Traz4Column = New CRP_Traz4Column()
        rpt.Site = Me.Site
        Return rpt
    End Function
