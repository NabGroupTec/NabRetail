...
Public Class CRP_Traz2Column
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Traz2Column.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Traz2Column
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Traz2Column = New CRP_Traz2Column()
        rpt.Site = Me.Site
        Return rpt
    End Function
