...
Public Class CRP_Resid_Daramad2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Resid_Daramad2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Resid_Daramad2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Resid_Daramad2 = New CRP_Resid_Daramad2()
        rpt.Site = Me.Site
        Return rpt
    End Function
