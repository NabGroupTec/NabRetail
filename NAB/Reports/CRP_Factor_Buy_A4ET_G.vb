...
Public Class CRP_Factor_Buy_A4ET_G
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRP_Factor_Buy_A4ET_G.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Factor_Buy_A4ET_G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRP_Factor_Buy_A4ET_G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Factor_Buy_A4ET_G = New CRP_Factor_Buy_A4ET_G()
        rpt.Site = Me.Site
        Return rpt
    End Function
