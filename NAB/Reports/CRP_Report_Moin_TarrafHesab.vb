...
Public Class CRP_Report_Moin_TarrafHesab
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRP_Report_Moin_TarrafHesab.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NAB.CRP_Report_Moin_TarrafHesab.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Tell() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Adres() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRP_Report_Moin_TarrafHesab
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRP_Report_Moin_TarrafHesab = New CRP_Report_Moin_TarrafHesab()
        rpt.Site = Me.Site
        Return rpt
    End Function
